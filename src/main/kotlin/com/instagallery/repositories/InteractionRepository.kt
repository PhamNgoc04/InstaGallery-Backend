...
class InteractionRepository {
    ...
    suspend fun getComments(postId: Long, page: Int, limit: Int): com.instagallery.models.common.PaginatedCommentsResponse = dbQuery {
        ...
        val commentsList = commentRows.map { row ->
            ...
            // Calculate pseudo replies count (Ideally should be cached like post's commentCount)
            val rCount = CommentsTable.selectAll().where { (CommentsTable.parentCommentId eq cId) and (CommentsTable.deletedAt.isNull()) }.count().toInt()
