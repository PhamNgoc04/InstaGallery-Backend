...
**Vấn Đề Ở Backend:** Có quá nhiều bảng cơ sở dữ liệu (Ví dụ: Đồ án có 21 bảng). AI không thể đoán được bảng `users` nối với bảng `posts` kiểu gì nếu không có Context.
